...
class DataHandler(Handler):
    ...
    def __init__(self, oval_ratio):
        ...
        for index, box_data in enumerate(self.box_list):
            ...
            ground = np.sqrt((box_data[2]) * int(box_data[3]))
        ...
        self.train_images_label_point_center = self.images_label_point_center[:154]
        self.train_images_label_object_detection = self.images_label_object_detection[:154]
        ...
        self.test_images_label_point_center = self.images_label_point_center[155:]
        self.test_images_label_object_detection = self.images_label_object_detection[155:]
